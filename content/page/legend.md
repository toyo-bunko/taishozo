...
（注１）大正蔵第1～55巻（漢文部分）の巻末には「略符（Abbreviations）」が採録されている。この「略符」は、大正蔵各巻の脚注に用いられた底本・校本を表す略号と、文字の異同等を略記するための校勘記号の説明からなり、読者が大正蔵各巻の脚注を理解するための凡例としての役割を果たしている。この略号・校勘記号の説明は巻ごとに微妙に異なっていて、大正蔵の初版の配本順に並べ換えてみると、全3
期14種に分類できる。
